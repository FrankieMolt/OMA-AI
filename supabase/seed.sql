...
(uuid_generate_v4(), 'Pascal\'s Wager', 'pascals-wager', 'Philosophical analysis of belief and expected value', 'Philosophy', '<p>Should you believe in God? Pascal argued that the expected value of belief is infinite if God exists.</p>', '[{"question": "Does expected value justify belief?", "options": ["Yes", "No", "It\'s more complex"]}]'),
