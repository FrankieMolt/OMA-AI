        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/NosytLabs" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="w-10 h-10 rounded-lg glass-card flex items-center justify-center text-zinc-400 hover:text-white hover:border-violet-500/30 active:scale-95 transition-all">
                <Code className="w-5 h-5" />
              </a>
              <a href="https://twitter.com/OMA_AI" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 rounded-lg glass-card flex items-center justify-center text-zinc-400 hover:text-white hover:border-violet-500/30 active:scale-95 transition-all">
                <X className="w-5 h-5" />
              </a>
              <a href="https://discord.gg/oma-ai" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="w-10 h-10 rounded-lg glass-card flex items-center justify-center text-zinc-400 hover:text-white hover:border-violet-500/30 active:scale-95 transition-all">
                <MessageSquare className="w-5 h-5" />
              </a>
              <a href="mailto:hello@oma-ai.com" aria-label="Email" className="w-10 h-10 rounded-lg glass-card flex items-center justify-center text-zinc-400 hover:text-white hover:border-violet-500/30 active:scale-95 transition-all">
