...
export function HeroSection() {
  return (
    <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 opacity-[0.02] bg-grid-hero" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-zinc-400 group-hover:text-zinc-300 transition-colors">MCP Marketplace · BYOK Key Management</span>
          </Link>
        </motion.div>
        ...
        >
          Your API keys.<br className="hidden sm:block" /> 
          <span className="animate-gradient-text">AI agents that use them.</span>
        </motion.h1>
        ...
        >
          {[
            { label: '7', sub: 'working MCPs', icon: '⚡' },
            { label: 'BYOK', sub: 'key vault', icon: '🔑' },
            { label: '<5ms', sub: 'latency', icon: '🚀' },
