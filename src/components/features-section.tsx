...
const features = [
  ...
  },
  {
    icon: Coins,
    title: 'x402 Payments',
    desc: 'Agents pay per call in USDC on Base. No subscriptions.',
    href: '/credits',
    accent: 'green'
  },
  {
    icon: Wallet,
    title: 'Agent Wallets',
    desc: 'ERC-7579 wallets let agents pay, earn, and transact autonomously.',
    href: '/soul',
    accent: 'cyan'
  },
  {
    ...
    desc: 'Build on open protocols. Your agents, your infrastructure.',
    href: '/publish',
    accent: 'amber'
  },
  {
    ...
    desc: 'Requests automatically route to the right model for each task.',
    href: '/models',
    accent: 'violet'
  },
  {
    ...
    desc: 'Spawn multiple agents that work together on complex tasks.',
    href: '/docs',
    accent: 'cyan'
  },
  {
    ...
    desc: 'Agents build reputation on-chain as they complete work.',
    href: '/soul',
    accent: 'green'
  },
  {
    ...
    desc: 'Transactions finalize in under a second on Base.',
    href: '/credits',
    accent: 'amber'
  }
];
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-3">
            What OMA-AI gives you
          </h2>
          <p className="text-zinc-400 text-lg max-w-lg mx-auto">
            The pieces you need to build AI agents that actually do things.
          </p>
        </MotionDiv>
