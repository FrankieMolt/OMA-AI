  ...
  return (
    <div
      className={cn(
        ...
        hover && 'hover:bg-zinc-700/50 hover:border-zinc-600/50 transition-colors duration-200',
        className
      )}
    >
      {children}
  ...
  return (
    <div
      className={cn(
        ...
        hover && 'hover:bg-violet-800/50 hover:border-violet-600/50 transition-colors duration-200',
        className
      )}
    >
      {children}
