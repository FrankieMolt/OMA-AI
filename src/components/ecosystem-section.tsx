        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-zinc-950 p-8 rounded-2xl border border-zinc-800 hover:border-zinc-700 transition-colors">
            ...
            <p className="text-zinc-400 mb-6">
              MCP connects AI agents to any external service or API. 
          ...
          <div className="bg-zinc-950 p-8 rounded-2xl border border-zinc-800 hover:border-zinc-700 transition-colors">
            ...
            <p className="text-zinc-400 mb-6">
              The HTTP 402 standard enables feeless micropayments on Base. 
              Agents pay each other without API keys or intermediaries.
            </p>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm">
                    AI agents buy and sell services from each other while they work.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm">
                    Agents that watch markets and execute trades automatically.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm">
                    Agents that pull research from search, databases, and APIs.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm">
                    Agents that chain multiple tools together for complex workflows.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
