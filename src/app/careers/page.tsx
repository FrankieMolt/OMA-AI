      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-zinc-900 rounded-lg p-6 border border-zinc-800">
          <p className="text-zinc-300 mb-6">
            Join us in building the future of autonomous AI infrastructure. We're looking for passionate individuals to help shape the next generation of agentic systems.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-zinc-800 rounded-lg p-4 border border-zinc-700">
              ...
              <ul className="space-y-1 text-zinc-400 text-xs mb-3">
                <li>• Docker & Kubernetes experience</li>
