...
export const metadata: Metadata = {
  ...
  description: 'Discover, deploy, and monetize AI agents with the premier MCP Marketplace. Access 34+ verified MCP servers with gasless x402 payments on Base network - no API keys, no subscriptions.',
  ...
  openGraph: {
    ...
    description: 'Discover, deploy, and monetize AI agents with the premier MCP Marketplace. Access 34+ verified MCP servers with gasless x402 payments on Base network.',
    images: [
      {
        url: '/icon-512.svg',
        width: 512,
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.className} bg-zinc-950 text-zinc-50 antialiased selection:bg-zinc-800`}>
        ...
        />
        <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:bg-violet-600 focus:text-white focus:outline-none focus:ring-2 focus:ring-violet-300 focus:ring-offset-2 focus:ring-offset-zinc-950 focus:px-4 focus:py-2 focus:rounded-lg focus:font-medium">
