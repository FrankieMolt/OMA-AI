      ...
      <div className="min-h-screen bg-zinc-950">
          ...
          <div className="container mx-auto px-4 max-w-7xl py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/logout" className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="container mx-auto px-4 max-w-7xl py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <StatCard title="MCPs Owned" value={3} icon={Zap} color="text-violet-400" bgColor="bg-violet-500/10" />
            <StatCard title="Total API Calls" value="12,847" icon={TrendingUp} color="text-green-400" bgColor="bg-green-500/10" />
            <StatCard title="Wallets Connected" value={1} icon={Users} color="text-blue-400" bgColor="bg-blue-500/10" />
            <StatCard title="Avg Rating" value="4.8" icon={DollarSign} color="text-amber-400" bgColor="bg-amber-500/10" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/publish" className="flex items-center gap-2 text-sm text-violet-400 hover:text-violet-300">
              ...
              <div className="space-y-3">
                <div className="block p-4 bg-zinc-800 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-semibold text-white">Weather API MCP</h3>
                      <p className="text-sm text-gray-400">Tools</p>
                    </div>
                    <div className="text-right">
                      <div className="flex items-center gap-1 text-yellow-400 text-sm">★ 4.9</div>
                      <div className="text-xs text-gray-400">5,230 calls</div>
                    </div>
                  </div>
                </div>
                <div className="block p-4 bg-zinc-800 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-semibold text-white">Image Processing MCP</h3>
                      <p className="text-sm text-gray-400">Media</p>
                    </div>
                    <div className="text-right">
                      <div className="flex items-center gap-1 text-yellow-400 text-sm">★ 4.7</div>
                      <div className="text-xs text-gray-400">3,412 calls</div>
                    </div>
                  </div>
                </div>
                <div className="block p-4 bg-zinc-800 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-semibold text-white">Data Analysis MCP</h3>
                      <p className="text-sm text-gray-400">Analytics</p>
                    </div>
                    <div className="text-right">
                      <div className="flex items-center gap-1 text-yellow-400 text-sm">★ 4.6</div>
                      <div className="text-xs text-gray-400">4,205 calls</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                ...
                <div className="flex items-center justify-between p-3 bg-zinc-800 rounded-lg">
                  <div>
                    <p className="font-semibold text-white capitalize">Ethereum</p>
                    <p className="text-xs text-gray-400 font-mono">0x7a3B...4fE2</p>
                  </div>
                  <span className="px-2 py-1 bg-green-500/10 text-green-400 text-xs rounded">Connected</span>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-white mb-2">$847.23</div>
                  <p className="text-sm text-gray-400 mb-4">Total lifetime earnings</p>
                  <Link href="/wallet/earnings" className="text-sm text-violet-400 hover:text-violet-300">
