...
export const supabase = isConfigured()
  ? (_supabase ??= createClient(supabaseUrl!, supabaseAnonKey!, {
      auth: { persistSession: true, autoRefreshToken: true, storageKey: 'oma-ai-primary' },
    }))
...
export const supabaseService = isConfigured()
  ? (_supabaseService ??= createClient(supabaseUrl!, supabaseAnonKey!, {
      auth: { persistSession: false, autoRefreshToken: false, storageKey: 'oma-ai-service' },
    }))
  : (null as unknown as SupabaseClient);
