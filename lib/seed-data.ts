  ...
  const sampleTasks = [
    {
      ...
      description: 'Create internal dashboard with Activity Feed, Calendar, Global Search, and Kanban Board',
  ...
  const sampleEvents = [
    {
      ...
      start_date: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 14, 0).toISOString(),
      end_date: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 15, 0).toISOString(),
      location: 'Virtual',
    ...
    },
    {
      ...
      start_date: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 10, 0).toISOString(),
      end_date: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 11, 0).toISOString(),
      location: 'Virtual',
      type: 'meeting' as const,
      status: 'scheduled' as const,
      tags: 'code-review'
    },
    {
      ...
      start_date: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 14).toISOString(),
    ...
    },
    {
      ...
      start_date: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 5, 2, 0).toISOString(),
