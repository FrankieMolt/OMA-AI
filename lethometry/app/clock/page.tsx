...
import { Clock, Timer, Activity, AlertCircle, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      <section className="pt-48 pb-20 px-4 md:px-14">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="text-5xl md:text-8xl font-light tracking-tighter leading-[0.9] mb-10 font-display text-memoria-text-hero">
             The Death<br/><span className="italic">Clock</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
             ...
             <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-8">
                <div className="space-y-8">
                   <div>
                      <label className="label-whisper mb-4 block">Current Biological Age</label>
                      <input 
                        type="range" 
                        min="1" 
                        max="100" 
                   ...
                   <div>
                      <label className="label-whisper mb-4 block">Projected Life Expectancy</label>
                      <input 
                        type="range" 
                        min="age" 
                        max="120" 
                   ...
                   <Button 
                    ...
                    className="w-full bg-memoria-text-hero text-memoria-bg-ultra-dark rounded-sm h-14 text-sm font-bold uppercase tracking-widest"
                   >
             ...
             <div className="relative">
                {isCalculated ? (
                   ...
                   >
                      <div className="grid grid-cols-2 gap-4">
                         <div className="bg-memoria-bg-card border border-memoria-border-muted p-6 rounded-sm text-center">
                            <span className="label-whisper mb-2 block">Days Remaining</span>
                            <div className="hero-number text-5xl">{timeLeft.days.toLocaleString()}</div>
                         </div>
                         <div className="bg-memoria-bg-card border border-memoria-border-muted p-6 rounded-sm text-center">
                            <span className="label-whisper mb-2 block">Percent Elapsed</span>
                      ...
                      <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10 text-center relative overflow-hidden">
                         ...
                         <span className="label-whisper mb-4 block text-red-500">Active Terminal Countdown</span>
                   ...
                   <div className="h-64 border border-dashed border-memoria-border-muted rounded-sm flex flex-col items-center justify-center text-memoria-text-meta">
      ...
      {isCalculated && (
        <section className="py-20 px-4 md:px-14 border-t border-memoria-border-muted">
           <div className="mx-auto max-w-7xl">
              <span className="label-whisper mb-8 block">Existence Grid (Weeks)</span>
              <div className="grid grid-cols-52 gap-1 md:gap-1.5">
