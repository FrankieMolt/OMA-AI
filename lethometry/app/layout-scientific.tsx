 ...
 * UPDATED: Switched to improved scientific CSS with loading states, hover effects, and animations
 * UPDATED: Mobile menu integrated with hamburger button
 */

import type { Metadata } from 'next'
import { Inter, JetBrains_Mono } from 'next/font/google'
import './globals-scientific.css' // Updated to scientific CSS
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.variable} ${jetbrainsMono.variable} font-sans antialiased custom-scrollbar smooth-scroll`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              <a className="flex items-center gap-3" href="/">
                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-scientific-blue to-scientific-purple flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-flask-conical w-5 h-5 text-white">
                    <path d="M14 2v6a2 2 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2"></path>
              ...
              <nav className="hidden md:flex items-center gap-1">
                <a className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors bg-primary/10 text-primary hover:shadow-md" href="/">
                ...
                <a className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors text-muted-foreground hover:text-foreground hover:bg-muted hover-lift" href="/experiments/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-flask-conical w-4 h-4">
                    <path d="M14 2v6a2 2 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2"></path>
                    <path d="M6.453 15h11.094"></path>
                    <path d="M8.5 2h7"></path>
                ...
                <a className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors text-muted-foreground hover:text-foreground hover:bg-muted hover-lift" href="/publications/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-book-open w-4 h-4">
                    ...
                    <path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1 1-1h-6a3 3 0 0 0-3 3 3 0 0 0-3 3 3 0 0 0-3 3z"></path>
                  </svg>
                  Publications
                </a>
                <a className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors text-muted-foreground hover:text-foreground hover:bg-muted hover-lift" href="/data/">
                ...
                <a className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors text-muted-foreground hover:text-foreground hover:bg-muted hover-lift" href="/methodology/">
                ...
                <a className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors text-muted-foreground hover:text-foreground hover:bg-muted hover-lift" href="/about/">
                ...
                <a className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors text-muted-foreground hover:text-foreground hover:bg-muted hover-lift" href="/guidelines/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-help w-4 h-4">
                    ...
                    <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 1-3 0-1-1 3 0 1 3 3 0-3 3 0-3 0-3 3 3 0-1 3 3 0-1-3 3 0 0-1-3 3 3-0 0-1 3 3 0-1-3 3 0-3 3 3 3-3 3z"></path>
                    <path d="M12 17h.01"></path>
                  </svg>
                  Guidelines
                </a>
              </nav>
              <button className="md:hidden p-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-muted hover-lift">
        ...
        {/* Main content with scientific patterns */}
