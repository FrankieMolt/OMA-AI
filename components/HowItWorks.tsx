  ...
  const steps = [
    {
      icon: Rocket,
      title: 'Build API',
      description: 'Create your API or MCP server with our SDK. Add pricing, documentation, and deploy to any platform.',
      details: [
    ...
    },
    {
      icon: Globe,
      title: 'Deploy & Price',
      description: 'List your API in our marketplace. Set per-call pricing, manage access keys, and monitor performance.',
      details: [
    ...
    },
    {
      icon: DollarSign,
      title: 'Earn Per Call',
      description: 'Receive automatic crypto payments via x402 on every API call. Get paid instantly, transparently, and reliably.',
      details: [
        'Instant settlement',
        'Transparent payouts',
        'Multi-chain support',
  ...
  const benefits = [
    {
      ...
      description: 'Get started in minutes with our SDK and extensive documentation'
    },
    {
      icon: Lock,
    ...
    },
    {
      ...
      description: 'Receive payments automatically on every successful API call'
    },
    {
      icon: TrendingUp,
      title: 'Grow Revenue',
            ...
            >
              ...
              <div className="glass-card p-8 rounded-2xl h-full">
                ...
                <div className={`w-16 h-16 rounded-xl bg-${
                  ...
                  <step.icon size={32} className={`text-${
                    step.color === 'purple' ? 'purple' :
                    step.color === 'blue' ? 'blue' :
                    'green'
                  }-400`} />
