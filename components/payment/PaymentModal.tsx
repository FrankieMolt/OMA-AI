            ...
            <div className="text-center py-8">
              {payment.status === "completed" ? (
                <>
                  ...
                  <h3 className="text-xl font-light text-memoria-text-hero mb-2">
                    Payment Successful!
                  </h3>
                  <p className="text-memoria-text-whisper text-sm">
            ...
            <>
              ...
              {!walletAddress ? (
                ...
                <div className="bg-memoria-bg-ultra-dark rounded-sm p-4">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-memoria-text-meta text-xs uppercase tracking-widest">
                      Wallet
                    </span>
                    <span className="text-memoria-text-whisper text-xs">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-memoria-text-hero font-light">
                      {balance} USDC
                    </span>
                  </div>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  value={calls}
                  onChange={(e) =>
                    setCalls(Math.max(1, parseInt(e.target.value) || 1))
                  }
                  min="1"
              ...
              <div className="bg-memoria-bg-ultra-dark rounded-sm p-4 space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-memoria-text-whisper text-sm">
                    Price per call
                  </span>
                  <span className="text-memoria-text-hero">
                    ${service.price_per_call.toFixed(4)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-memoria-text-whisper text-sm">
                ...
                <div className="border-t border-memoria-border-muted pt-2 mt-2">
                  <div className="flex justify-between items-center">
                    <span className="text-memoria-text-hero text-sm font-medium">
                      Total
                    </span>
                    <span className="text-memoria-text-hero text-lg font-light">
