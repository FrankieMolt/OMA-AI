      ...
      <div style={{ maxWidth: "87.5rem", margin: "0 auto" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Autonomous infrastructure for the agent economy. Secure,
              ...
              >
                {section.links.map((link) => (
                  <Link
                    ...
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.color = colors.text.neutral200)
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.color = colors.text.neutral600)
                    }
                  >
                    {link.label}
                  </Link>
