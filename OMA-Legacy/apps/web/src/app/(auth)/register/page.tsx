  ...
  return (
    <Card className="glass-enhanced border-border/60 shadow-2xl">
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl font-bold text-center">{strings.auth.register.title}</CardTitle>
        <CardDescription className="text-center">
          {strings.auth.register.description}
        </CardDescription>
      </CardHeader>
      <CardContent className="grid gap-4">
        ...
        <div className="grid gap-2">
          <Label htmlFor="name">{strings.auth.common.name_label}</Label>
          <Input id="name" placeholder={strings.auth.common.name_placeholder} className="glass-input" />
        </div>
        <div className="grid gap-2">
      ...
      <CardFooter className="flex flex-col gap-4">
        <Button className="w-full bg-primary hover:bg-primary/90">{strings.auth.register.button}</Button>
        <p className="text-xs text-center text-muted-foreground">
          {strings.auth.register.has_account}{' '}
