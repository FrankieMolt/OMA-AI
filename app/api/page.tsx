...
export const metadata: Metadata = {
  ...
  description:
    "Complete API reference for OMA-AI marketplace. Access crypto prices, trading signals, and on-chain data.",
};
  ...
  const endpoints = [
    {
      ...
      path: "/health",
      cost: "Free",
      desc: "API health check and status",
      color: "green",
    },
    {
      method: "GET",
      path: "/price",
      cost: "$0.05",
      desc: "Real-time SOL, BTC, ETH prices from Coinbase",
      color: "blue",
    },
    {
      method: "GET",
      path: "/signal",
      cost: "$0.25",
      desc: "AI-powered trading signals and indicators",
      color: "purple",
    },
    {
      method: "GET",
      path: "/onchain",
      cost: "$0.50",
      desc: "On-chain analytics and blockchain metrics",
      color: "orange",
    },
    {
      method: "GET",
      path: "/stats",
      cost: "Free",
      desc: "API usage statistics and metrics",
      color: "gray",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-[#0a0a15] to-[#050510] border border-white/5 mb-8">
            <div className="flex items-center gap-4 mb-6 flex-wrap">
              <div
                className={`w-3 h-3 rounded-full ${health.status === "ok" ? "bg-green-500 shadow-lg shadow-green-500/50" : "bg-red-500"}`}
              />
              ...
              <span className="text-gray-400">
                Uptime: {Math.round((health.uptime || 0) / 3600)}h
              </span>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="p-4 rounded-xl bg-[#050510] border border-white/5">
                <div className="font-orbitron text-3xl font-bold text-green-400 mb-1">
                  {stats.realPayments || 0}
                </div>
                <div className="text-gray-400">Payments</div>
              </div>
              <div className="p-4 rounded-xl bg-[#050510] border border-white/5">
                <div className="font-orbitron text-3xl font-bold text-blue-400 mb-1">
                ...
                {endpoints.map((ep, i) => (
                  ...
                  >
                    <td className="px-6 py-5">
                      <span
                        className={`px-2 py-1 rounded text-xs font-bold ${colorClasses[ep.color]}`}
                      >
                        {ep.method}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-5">
                      <a
                        ...
                        target="_blank"
                        className="px-4 py-2 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 rounded-lg text-blue-400 text-sm font-medium transition-colors cursor-pointer"
                      >
                        Test →
                      </a>
                    </td>
  ...
  "data": {
    ...
    "eth": { "price": 2700, "change_24h": 3.4 }
              ...
              <p className="text-gray-400 text-sm mt-4">
                💡 Payments are handled automatically via x402 micropayment
                protocol
              </p>
            </div>
          </div>
