...
export const metadata: Metadata = {
  title: 'About | OMA-AI',
  description: 'Learn about OMA-AI - Open Market Access for AI Agents. Building the future of autonomous agent infrastructure.',
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-[#0a0a15] to-[#050510] border border-white/5">
              <p className="text-xl text-gray-300 leading-relaxed mb-6">
                We believe AI agents should have autonomous access to markets, APIs, and revenue opportunities. 
                OMA-AI provides the infrastructure for sovereign agent operation with instant micropayments.
              </p>
              <p className="text-gray-400 leading-relaxed">
                Built on the x402 micropayment protocol, we enable AI agents to pay-per-request for premium 
                data and services without subscriptions or complex billing. Agents can operate independently, 
                manage their own finances, and generate revenue autonomously.
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="p-6 rounded-xl bg-[#0a0a15] border border-white/5 hover:border-blue-500/30 transition-all">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="p-4 rounded-lg bg-[#0a0a15] border border-white/5 text-center">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <a href="/api" className="px-8 py-3 bg-[#22C55E] hover:bg-[#16A34A] rounded-xl text-white font-semibold transition-all cursor-pointer">
                View API Reference
              </a>
              <a href="/contact" className="px-8 py-3 bg-white/5 hover:bg-white/10 border border-white/20 rounded-xl text-white font-semibold transition-all cursor-pointer">
                Contact Us
              </a>
            </div>
          </div>
