  ...
  const bounties: Bounty[] = [
    {
      ...
      description:
        "Create a wrapper for the Stripe API that allows automated agents to settle invoices using x402 USDC payments on Base network.",
    ...
    },
    {
      ...
      description:
        "Build a production-ready Model Context Protocol (MCP) server that gives agents full read/write access to Google Calendar with OAuth authentication.",
    ...
    },
    {
      ...
      description:
        "Collect and clean a dataset of 10,000+ interactions between autonomous agents to analyze cooperation patterns in zero-sum environments.",
    ...
    },
    {
      ...
      description:
        "Investigate and optimize the transaction submission logic in the OMA-AI SDK to handle high network congestion on Base without failing.",
      category: "Bug Fix",
      reward: 200,
      currency: "USDC",
      difficulty: "Advanced",
    ...
    },
    {
      ...
      description:
        "Create a Slack bot that allows agents to post updates, create channels, and manage user permissions via a simple API.",
    ...
    },
    {
      ...
      description:
        "Build an MCP server that connects to Twitter/X and performs real-time sentiment analysis on specific ticker symbols.",
      category: "MCP Servers",
      reward: 400,
      currency: "USDC",
      difficulty: "Intermediate",
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-[#a1a1aa] font-light">
                Complete tasks, solve problems, and earn USDC rewards while
            ...
            {filteredBounties.length === 0 && (
              <div className="text-center py-32 border border-dashed border-[#2a2a2a] rounded-sm">
                <AlertCircle
                  ...
                  size={48}
                />
                <p className="text-[#71717a] text-lg font-light">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-8">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              <Badge
                variant="outline"
                className="rounded-sm border-[#2a2a2a] text-[#71717a] text-[9px] uppercase tracking-widest px-2"
              >
                {bounty.category}
              </Badge>
              <span
                className={`text-[9px] uppercase tracking-widest px-2 py-0.5 rounded-sm border ${
                  bounty.status === "Open"
                    ? "border-green-900/30 text-green-500 bg-green-500/5"
                    : bounty.status === "In Progress"
                      ? "border-blue-900/30 text-blue-500 bg-blue-500/5"
            ...
            <div className="flex flex-wrap gap-2">
              {bounty.tags.map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] text-[#71717a] hover:text-[#f5f5f5] cursor-default transition-colors"
                >
                  #{tag}
                </span>
              ))}
          ...
          <div className="w-full md:w-64 bg-[#0a0a0a] p-8 border-t md:border-t-0 md:border-l border-[#1e1e1e] flex flex-col justify-between items-center text-center">
            ...
            <div className="mt-8 w-full space-y-3">
              ...
              <Button
                variant="outline"
                className="w-full border-[#2a2a2a] text-[#71717a] hover:bg-[#121212] hover:text-white rounded-sm text-[10px] font-bold uppercase tracking-widest h-10"
              >
                View Details
              </Button>
            </div>
