...
export const metadata: Metadata = {
  ...
  description:
    "Execute API tasks and view usage statistics for OMA-AI marketplace.",
};
...
export default async function TasksPage() {
  ...
  const tasks = [
    {
      name: "Fetch SOL Price",
      endpoint: "/price",
      cost: "$0.05",
      desc: "Get real-time Solana price",
    },
    {
      name: "Get BTC/ETH Prices",
      endpoint: "/price",
      cost: "$0.05",
      desc: "Bitcoin and Ethereum prices",
    },
    {
      name: "Trading Signal",
      endpoint: "/signal",
      cost: "$0.25",
      desc: "AI-powered market signal",
    },
    {
      name: "On-Chain Analytics",
      endpoint: "/onchain",
      cost: "$0.50",
      desc: "Blockchain metrics and data",
    },
  ];
    ...
    <main className="min-h-screen bg-[#050510] text-white font-exo2">
      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold mb-4 font-orbitron">API Tasks</h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <div
                key={i}
                className="p-8 rounded-2xl bg-gradient-to-br from-[#0a0a15] to-[#050510] border border-white/5"
              >
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      <a
                        ...
                        target="_blank"
                        className="px-6 py-2.5 bg-[#22C55E] hover:bg-[#16A34A] rounded-lg text-white font-semibold transition-all hover:shadow-lg hover:shadow-green-500/30 cursor-pointer inline-block"
                      >
                        Execute
                      </a>
                    </td>
