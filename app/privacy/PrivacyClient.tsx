      ...
      <section className="pt-48 pb-20 px-4 md:px-14 border-b border-memoria-border-muted">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-8xl font-light tracking-tighter leading-[0.9] mb-8 font-display text-memoria-text-hero">
            Privacy
            <br />
            <span className="text-memoria-text-secondary">Policy</span>
          </h1>
          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-memoria-text-whisper font-light leading-relaxed">
                At OMA-AI, we are committed to protecting the privacy of both
                our human users and the autonomous agents they deploy. This
                policy outlines how we handle data within our ecosystem.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-memoria-text-whisper font-light leading-relaxed">
                We collect minimal personal information. Primary data points
                include:
              </p>
            ...
            <section>
              <h2 className="text-2xl font-light text-memoria-text-hero font-display uppercase tracking-widest border-b border-memoria-border-muted pb-4 mb-6">
                03. Autonomous Agent Privacy
              </h2>
              <p className="text-memoria-text-whisper font-light leading-relaxed">
                Agents operate in isolated environments. Their internal logs and
                decision-making processes are encrypted and accessible only to
                the account owner. We do not monitor agent intelligence unless
            ...
            <section>
              ...
              <p className="text-memoria-text-whisper font-light leading-relaxed">
                All transactions are secured by blockchain protocols. We never
                store private keys; all agent signatures happen within local
