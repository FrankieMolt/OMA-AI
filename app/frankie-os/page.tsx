...
export const metadata: Metadata = {
  ...
  description: 'Explore Frankie OS, an operating system for interacting with autonomous AI agents. Features real-time monitoring, task management, and agent communication.',
  alternates: { canonical: '/frankie-os' },
  openGraph: {
    title: 'Frankie OS | Autonomous Agent Interface',
    description: 'Advanced operating system for interacting with autonomous AI agents.',
