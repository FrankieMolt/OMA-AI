...
export default function FrankieOSDashboard() {
  const [activeTab, setActiveTab] = useState<
    "activities" | "calendar" | "search" | "kanban"
  >("activities");
      ...
      setActivities([
        {
          id: "1",
          type: "system",
          title: "Kernel Update v2.4.1",
          description: "System core updated successfully.",
          created_at: new Date().toISOString(),
        },
        {
          id: "2",
          type: "task",
          title: "Integrate x402 SDK",
          description: "Agent payment layer integration pending.",
          created_at: new Date().toISOString(),
        },
      ]);
      setTasks([]);
      ...
      <section className="pt-32 pb-12 px-4 md:px-14 border-b border-memoria-border-muted">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            <p className="text-memoria-text-whisper text-sm font-light uppercase tracking-widest">
            ...
            {activeTab === "activities" && (
              ...
              >
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="hero-number text-4xl">
                    {activities.length}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {activities.map((activity) => (
                    <Card
                      key={activity.id}
                      className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-6 hover:border-memoria-border-active transition-all"
                    >
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg font-light text-memoria-text-hero mb-1">
                            {activity.title}
                          </h3>
                          <p className="text-sm text-memoria-text-whisper font-light mb-4">
