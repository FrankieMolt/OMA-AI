    ...
    <div className="min-h-screen bg-memoria-bg-ultra-dark text-memoria-text-hero flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-light text-memoria-text-hero mb-2 font-display">
            Reset Password
          </h1>
        ...
        <form className="space-y-6" aria-label="Password reset form">
          <div>
            <label
              htmlFor="email"
              className="block text-[10px] uppercase tracking-widest text-memoria-text-label mb-2"
            >
              Email
            </label>
            <input
