...
export const metadata: Metadata = {
  ...
  description:
    "Real-time dashboard showing API performance, crypto prices, and revenue metrics.",
};
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050510]/90 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div
              className={`w-2 h-2 rounded-full ${health.status === "ok" ? "bg-green-500 animate-pulse" : "bg-red-500"} shadow-lg ${health.status === "ok" ? "shadow-green-500/50" : ""}`}
            />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-8">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-2xl bg-gradient-to-br from-[#0a0a15] to-[#050510] border border-white/5 hover:border-blue-500/30 transition-all"
              >
                <div className="text-gray-400 text-sm mb-2">{metric.label}</div>
                <div
                  className={`font-orbitron text-4xl font-bold mb-1 ${
                    metric.color === "green"
                      ? "text-green-400"
                      : metric.color === "blue"
                        ? "text-blue-400"
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-[#0a0a15] to-[#050510] border border-white/5 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="p-6 rounded-xl bg-[#050510] border border-white/5 hover:border-blue-500/20 transition-all"
                >
                  ...
                  <div
                    className={`font-orbitron text-4xl font-bold mb-2 ${
                      crypto.color === "blue"
                        ? "text-blue-400"
                        : crypto.color === "orange"
                          ? "text-orange-400"
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-[#0a0a15] to-[#050510] border border-white/5">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center justify-between py-4 border-t border-white/5 hover:bg-[#050510] px-4 rounded-lg transition-colors cursor-pointer"
                >
