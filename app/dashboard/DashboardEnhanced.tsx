...
export default function EnhancedDashboard() {
  ...
  const { selectedAPIs, toggleAPI, clearSelection, exportSelected } =
    useAPISelection();
  ...
  const handleExport = (format: "csv" | "json") => {
    ...
    addToast(
      `Exported ${selectedAPIs.length} APIs as ${format.toUpperCase()}`,
      "success",
    );
  };
    ...
    <>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        >
          ...
          <kbd className="px-2 py-1 text-xs bg-memoria-bg-surface rounded">
            ⌘K
          </kbd>
        </button>
