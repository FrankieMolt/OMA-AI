  ...
  const fallbackServices: ApiService[] = [
    {
      ...
      name: "GPT-4 Turbo",
      description:
        "Advanced language model for complex reasoning and code generation",
      category: "AI & ML",
      rating: 4.9,
      price: 0.01,
      priceType: "per_call",
    ...
    },
    {
      ...
      description:
        "Connect your agents to GitHub repositories, issues, and PRs",
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-14">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              <Link
                href="/"
                className="text-xl font-light text-memoria-text-hero tracking-tight"
              >
                OMA SYSTEMS
              </Link>
              <span className="text-memoria-border-muted">/</span>
              <span className="text-sm text-memoria-text-whisper">
                API Marketplace
              </span>
            </div>
            ...
            <div className="flex items-center gap-6">
              <Link
                href="/docs"
                className="hidden md:flex items-center gap-2 text-memoria-text-whisper hover:text-white transition-colors text-sm uppercase tracking-widest"
              >
      ...
      <section className="py-32 px-4 md:px-14">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            <Badge
              variant="outline"
              className="mb-8 rounded-sm uppercase tracking-[0.2em] text-[10px] py-1 border-memoria-border-default text-memoria-text-whisper px-4"
            >
              Discover APIs
            </Badge>
            ...
            <h1 className="text-5xl md:text-8xl font-light tracking-tighter leading-[0.9] mb-8 font-display text-memoria-text-hero">
              Powerful APIs for
              <br />
              <span className="text-memoria-text-secondary">
                Autonomous Agents
              </span>
            </h1>

            <p className="text-lg md:text-xl text-memoria-text-whisper mb-10 font-light leading-relaxed max-w-2xl">
              Access the best AI, blockchain, and data APIs. Pay only for what
              you use with
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-light tracking-tight font-display">
                Top APIs
              </h2>
            </div>
            <Link
              href="/marketplace"
              className="hidden md:flex items-center gap-2 text-memoria-text-whisper hover:text-white transition-colors text-xs uppercase tracking-widest"
            >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {filteredServices.length === 0 && !loading && (
            <div className="text-center py-32 border border-memoria-border-muted rounded-sm">
              <Code
                className="text-memoria-border-muted mx-auto mb-6"
                size={48}
              />
              <p className="text-memoria-text-whisper text-lg">
      ...
      <section className="py-40 px-4 md:px-14 text-center border-t border-memoria-border-muted bg-memoria-bg-card/30">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-memoria-text-whisper mb-10 max-w-2xl mx-auto font-light">
            Start building your app today. Get your free API key and integrate
            in minutes.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/docs" className="no-underline">
              <Button
                variant="outline"
                className="border-memoria-border-muted text-memoria-text-whisper hover:text-white rounded-sm px-12 h-14 text-xs font-bold uppercase tracking-widest"
              >
                Documentation
              </Button>
            </Link>
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <h3 className="text-lg font-light text-memoria-text-hero">
                  {service.name}
                </h3>
                {service.featured && (
                  <Badge
                    variant="outline"
                    className="rounded-sm text-[9px] uppercase tracking-widest border-memoria-border-default text-memoria-text-meta"
                  >
                    Featured
                  </Badge>
                )}
              </div>
              <p className="text-sm text-memoria-text-whisper line-clamp-2 font-light">
                {service.description}
              </p>
            </div>
          </div>
              ...
              <Star
                ...
                className={
                  i < Math.floor(service.rating)
                    ? "text-white"
                    : "text-memoria-border-muted"
                }
              />
            ))}
            <span className="text-xs text-memoria-text-whisper ml-2">
              {service.rating}
            </span>
          </div>
              ...
              <div className="flex items-baseline gap-1">
                {isFree ? (
                  ...
                  <>
                    ...
                    <span className="text-xs text-memoria-text-meta">
                      /{service.priceType === "per_call" ? "call" : "mo"}
                    </span>
                  </>
                )}
              </div>
              <div className="text-[10px] text-memoria-text-meta">
