        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert">
            ...
            <p className="text-gray-400">
              Use of OMA-AI APIs requires payment via x402 protocol. All usage
              is subject to fair use policies.
            </p>

            <h2 className="text-xl font-bold text-white mt-8 mb-4">Payments</h2>
            <p className="text-gray-400">
              Payments are non-refundable. All transactions are final and
              recorded on-chain.
            </p>
            ...
            <p className="text-gray-400">
              OMA-AI is provided "as is". We are not liable for any losses
              resulting from API usage.
            </p>

            <h2 className="text-xl font-bold text-white mt-8 mb-4">Contact</h2>
            <p className="text-gray-400">
              For terms inquiries: frankie@agentmail.to
            </p>
          </div>
        </div>
      </div>
