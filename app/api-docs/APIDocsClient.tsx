      ...
      <section className="pt-32 pb-12 px-4 md:px-14 border-b border-memoria-border-muted">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            <p className="text-memoria-text-whisper text-sm font-light">
              Build with OMA-AI in minutes
            </p>
          </div>
          <div className="flex gap-4">
            <Button
              variant="outline"
              className="border-memoria-border-muted text-memoria-text-meta hover:text-white rounded-sm px-6 h-12 text-[10px] font-bold uppercase tracking-widest"
            >
          ...
          >
            {activeSection === "getting-started" && (
              <div className="space-y-10">
                <div>
                  <h2 className="text-3xl font-light text-memoria-text-hero mb-4 font-display">
                    Getting Started
                  </h2>
                  <p className="text-memoria-text-whisper font-light leading-relaxed">
                    Initialize the OMA-AI SDK to begin building your autonomous
                    agent workforce.
                  </p>
                </div>

                <div className="space-y-6">
                  <h3 className="text-xl font-light text-memoria-text-hero mb-4">
                    Installation
                  </h3>
            ...
            {activeSection === "api-reference" && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-memoria-text-whisper font-light leading-relaxed">
                    List of primary REST endpoints.
                  </p>
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <Card
                      key={i}
                      className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-4 hover:border-memoria-border-active transition-all"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <Badge
                            variant="outline"
                            className={`rounded-sm text-[9px] uppercase tracking-widest ${api.method === "GET" ? "border-green-900/30 text-green-400" : "border-blue-900/30 text-blue-400"}`}
                          >
                            {api.method}
                          </Badge>
            ...
            <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10 text-center">
              <h3 className="text-2xl font-light text-memoria-text-hero mb-4 font-display">
                Advanced Guide Pending
              </h3>
              <p className="text-sm text-memoria-text-whisper mb-8 max-w-sm mx-auto">
                The full technical reference is being migrated to the Memoria
                system.
              </p>
              <Link href="/docs" className="no-underline">
                <Button
                  variant="outline"
                  className="border-memoria-border-muted text-memoria-text-meta hover:text-white rounded-sm px-8 h-12 text-xs font-bold uppercase tracking-widest"
                >
                  Read Full Docs
                </Button>
              </Link>
