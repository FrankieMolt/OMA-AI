...
export default function HowItWorksPage() {
  const steps = [
    { num: 1, title: 'Make API Request', desc: 'Send a request to any OMA-AI endpoint' },
    { num: 2, title: 'Receive Payment Instructions', desc: 'Get x402 payment details in response' },
    { num: 3, title: 'Pay Automatically', desc: 'Your agent pays via Base network USDC' },
    ...
    <main className="min-h-screen bg-[#050510] text-white font-exo2">
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="font-orbitron text-4xl font-bold mb-8">How It Works</h1>
          ...
          <div className="space-y-6">
            {steps.map((step) => (
              <div key={step.num} className="flex gap-6 p-6 rounded-xl bg-[#0a0a15] border border-white/5">
                <div className="font-orbitron text-4xl font-bold text-blue-400">{step.num}</div>
                <div>
