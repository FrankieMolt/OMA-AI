  ...
  const steps = [
    {
      ...
      title: "Discovery",
      description:
        "Explore the marketplace of APIs, MCP servers, and agent skills. Filter by performance and price.",
      icon: <Globe size={32} />,
    },
    {
      step: "02",
      title: "Simulation",
      description:
        "Test API integrations directly in the sandbox before deploying your agent to production.",
      icon: <Zap size={32} />,
    },
    {
      step: "03",
      title: "Deployment",
      description:
        "Generate unique API keys and deploy your autonomous agents with x402 payment support.",
      icon: <Code size={32} />,
    },
  ];
      ...
      <section className="pt-48 pb-20 px-4 md:px-14">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-8xl font-light tracking-tighter leading-[0.9] mb-8 font-display text-memoria-text-hero">
            System
            <br />
            <span className="text-memoria-text-secondary">Operation</span>
          </h1>
          <p className="text-xl text-memoria-text-whisper max-w-2xl font-light leading-relaxed">
            The OMA-AI marketplace facilitates seamless commerce between human
            developers, API providers, and autonomous agents.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10 hover:border-memoria-border-active transition-all">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h3 className="text-3xl font-light font-display text-memoria-text-hero">
                  For Providers
                </h3>
              </div>
              <p className="text-memoria-text-whisper font-light leading-relaxed mb-10">
                List your APIs and MCP servers to reach a global network of
                autonomous AI agents. Automated billing via x402.
              </p>
              <div className="space-y-4">
                <div className="flex gap-3 text-xs text-memoria-text-meta uppercase tracking-widest">
                  <CheckCircle size={14} className="text-memoria-text-hero" />{" "}
            ...
            <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10 hover:border-memoria-border-active transition-all">
              ...
              <p className="text-memoria-text-whisper font-light leading-relaxed mb-10">
                Empower your agents with specialized capabilities. Discovery and
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 text-center border-r border-memoria-border-muted last:border-0">
              <Wallet
                size={48}
                className="text-memoria-text-hero mx-auto mb-6"
              />
              <h4 className="text-xl font-light mb-4 text-memoria-text-hero font-display">
                x402 Protocol
              </h4>
              <p className="text-xs text-memoria-text-whisper leading-relaxed">
                Decentralized payment layer for instant settlement between
            ...
            <div className="p-8 text-center border-r border-memoria-border-muted last:border-0">
              ...
              <p className="text-xs text-memoria-text-whisper leading-relaxed">
                Model Context Protocol integration for universal tool
                connectivity.
              </p>
            </div>
            <div className="p-8 text-center">
              ...
              <p className="text-xs text-memoria-text-whisper leading-relaxed">
                Secure OAuth flow designed specifically for autonomous machine
                entities.
              </p>
            </div>
          </div>
