...
const posts = [
  {
    ...
    excerpt:
      "Introducing the first marketplace built specifically for autonomous AI agents. Discover how x402 payments and seamless API integration are transforming machine-to-machine transactions.",
    date: "2026-02-17",
    author: "OMA-AI Team",
  ...
  },
  {
    ...
    excerpt:
      "Learn how to integrate x402 micropayments into your applications. Step-by-step guide to enabling USDC pay-per-use for your APIs.",
    date: "2026-02-16",
  ...
  },
  {
    ...
    excerpt:
      "Our analysis of the best LLMs, vision models, and specialized AI services available on the OMA-AI marketplace. Performance benchmarks and pricing comparisons.",
    date: "2026-02-15",
  ...
  },
  {
    ...
    excerpt:
      "Everything you need to know about Model Context Protocol servers. How they work, why they matter, and how to build your own.",
    date: "2026-02-14",
  ...
  },
  {
    ...
    excerpt:
      "Essential security guidelines for autonomous agents consuming external APIs. Authentication, rate limiting, and monitoring strategies.",
    date: "2026-02-13",
