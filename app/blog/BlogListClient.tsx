  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Announcing OMA-AI, the infrastructure that provides autonomous agents with the tools to discover and pay for services autonomously.",
      date: "Feb 07, 2026",
      author: "OMA-AI Team",
    ...
    },
    {
      ...
      excerpt:
        "Discover how OMA-AI creates the first unified marketplace where both humans and autonomous AI agents can transact seamlessly.",
      date: "Feb 06, 2026",
      author: "OMA Team",
      category: "Platform",
      readTime: "5 min read",
    ...
    },
    {
      ...
      excerpt:
        "Learn about x402, the HTTP-native payment protocol designed specifically for autonomous machine agents.",
      date: "Feb 06, 2026",
      author: "OMA Team",
      category: "Payments",
      ...
      <section className="pt-48 pb-20 px-4 md:px-14">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-8xl font-light tracking-tighter leading-[0.9] mb-8 font-display text-memoria-text-hero">
            OMA-AI
            <br />
            <span className="text-memoria-text-secondary">Insights</span>
          </h1>
          <p className="text-xl text-memoria-text-whisper max-w-2xl font-light leading-relaxed mb-8">
            The latest developments in autonomous agent economy, protocol
            updates, and industry analysis. Stay informed about the future of
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-memoria-bg-card border border-memoria-border-default p-6 rounded-sm">
              ...
              <p className="text-sm text-memoria-text-whisper font-light">
                Announcements about new features, API additions, and platform
                improvements directly from the OMA-AI engineering team.
              </p>
            </div>
            <div className="bg-memoria-bg-card border border-memoria-border-default p-6 rounded-sm">
              ...
              <p className="text-sm text-memoria-text-whisper font-light">
                Analysis of emerging trends in autonomous AI, decentralized
                infrastructure, and the future of machine commerce and digital
                labor.
              </p>
            </div>
          </div>
          ...
          <p className="text-xs text-memoria-text-meta max-w-sm mx-auto font-light">
            Get weekly updates on OMA protocol and agent economy insights. No
            spam, just engineering.
          </p>
        </div>
      </section>
      ...
      <section className="py-40 px-4 md:px-14 text-center border-t border-memoria-border-muted bg-memoria-bg-card/30">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-sm text-memoria-text-whisper mb-10 font-light max-w-md mx-auto">
            Connect with developers building the future of autonomous agents.
            Get access to private Discord, GitHub discussions, and exclusive
            content.
          </p>
