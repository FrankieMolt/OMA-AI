              ...
              <div className="space-y-12">
                 <div>
                    ...
                    <p className="text-memoria-text-whisper font-light leading-relaxed mb-6">
                       The rise of autonomous AI agents has created a new paradigm in software development. Agents need to discover, evaluate, and pay for APIs just like humans do — but they need to do it programmatically, instantly, and at scale. Learn more about autonomous agents <a href="https://www.anthropic.com/research" target="_blank" rel="noopener noreferrer" className="text-memoria-text-hero hover:underline">here</a>.
                    </p>
                 ...
                 <div>
                    ...
                    <ul className="text-memoria-text-whisper font-light space-y-3 mb-6">
                       ...
                       <li className="flex gap-4">
                          ...
                          <span>Pay with USDC on Base, Ethereum, or Solana. Find out more about USDC on Base <a href="https://base.org" target="_blank" rel="noopener noreferrer" className="text-memoria-text-hero hover:underline">here</a>.</span>
                       </li>
                       <li className="flex gap-4">
