...
export default function PricingClient() {
  const plans = [
    ...
    },
    {
      ...
      price: "49",
      description:
        "Advanced features for scaling production-grade agent networks.",
      features: [
    ...
    },
    {
      ...
      price: "Custom",
      description:
        "Custom infrastructure and support for large-scale deployments.",
      features: [
      ...
      <section className="pt-48 pb-20 px-4 md:px-14">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-8xl font-light tracking-tighter leading-[0.9] mb-8 font-display text-memoria-text-hero">
            Scale Your
            <br />
            <span className="text-memoria-text-secondary">Agent Workforce</span>
          </h1>
          <p className="text-xl text-memoria-text-whisper max-w-2xl font-light leading-relaxed">
            Transparent pricing for a machine-to-machine economy. Combine
            traditional subscriptions with decentralized micropayments.
          </p>
        </div>
      </section>
            ...
            >
              {plan.popular && (
                <div className="absolute top-4 right-4">
                  <Badge className="bg-memoria-text-secondary text-white rounded-full text-[8px] font-bold uppercase tracking-widest px-2">
                    Most Popular
                  </Badge>
                </div>
              )}
              ...
              <div className="mb-10">
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  {plan.price !== "Custom" && (
                    <span className="text-memoria-text-meta text-sm uppercase tracking-widest font-bold">
                      /mo
                    </span>
                  )}
                  {plan.price === "Custom" && (
                    <span className="hero-number text-5xl text-memoria-text-hero">
                      Custom
                    </span>
                  )}
                </div>
              ...
              <div className="space-y-4 mb-10">
                {plan.features.map((feature) => (
                  <div
                    key={feature}
                    className="flex items-start gap-3 text-xs text-memoria-text-meta"
                  >
                    <Check
                      size={14}
                      className="text-memoria-text-secondary shrink-0 mt-0.5"
                    />
                    <span>{feature}</span>
                  </div>
                ))}
      ...
      <section className="py-32 px-4 md:px-14 bg-memoria-bg-card/30 border-y border-memoria-border-muted">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <span className="label-whisper mb-6 block">
              ...
              <p className="text-lg text-memoria-text-whisper font-light leading-relaxed mb-6">
                OMA-AI introduces a hybrid model. Your subscription covers the
                core infrastructure, while x402 micropayments allow your agents
                to pay for third-party services on-demand.
              </p>
              <div className="grid grid-cols-2 gap-8 mt-12">
                <div>
                  <div className="hero-number text-4xl mb-2 text-memoria-text-hero">
                    0%
                  </div>
            ...
            <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-12">
              <h3 className="text-2xl font-light mb-8 font-display uppercase tracking-widest">
                Sample Usage
              </h3>
              <div className="space-y-6">
                <div className="flex justify-between items-center pb-4 border-b border-memoria-border-muted">
                  ...
                  <span className="text-sm font-bold text-memoria-text-hero font-mono">
                    0.005 USDC
                  </span>
                </div>
                <div className="flex justify-between items-center pb-4 border-b border-memoria-border-muted">
                ...
                <div className="pt-4 flex justify-between items-center">
                  <span className="text-base font-bold text-memoria-text-hero uppercase tracking-widest">
                    Total Agent Cost
                  </span>
                  <span className="text-xl font-bold text-memoria-text-secondary font-mono">
                    0.008 USDC
                  </span>
                </div>
              </div>
      ...
      <section className="py-32 px-4 md:px-14">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            {faq.map((item, i) => (
              <div key={i}>
                <h4 className="text-xl font-normal text-memoria-text-hero mb-4 font-display uppercase tracking-widest">
                  {item.q}
                </h4>
