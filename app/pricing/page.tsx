...
export const metadata: Metadata = {
  ...
  description: 'Simple, transparent pricing for OMA-AI marketplace. Pay per request with instant micropayments.',
}
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050510]/90 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3 text-white cursor-pointer group">
            ...
            <span className="font-bold text-lg tracking-tight font-orbitron">Pricing</span>
          </a>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Pay only for what you use. No subscriptions, no hidden fees. Instant micropayments on Base network.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {plans.map((plan, i) => (
              <div key={i} className={`relative p-8 rounded-2xl ${
                plan.popular
                ...
                <div className="mb-4">
                  <span className="text-5xl font-bold font-orbitron">{plan.price}</span>
                ...
                <a href={plan.ctaLink} className={`block w-full py-3 rounded-xl text-center font-semibold transition-all cursor-pointer ${
                  plan.popular
          ...
          <div className="rounded-2xl bg-[#0a0a15] border border-white/5 overflow-hidden mb-16">
            ...
            <table className="w-full">
              <thead className="bg-[#050510]">
                <tr>
                  <th className="text-left px-6 py-4 text-sm font-semibold text-gray-400">API Endpoint</th>
              ...
              <tbody>
                {apis.map((api, i) => (
                  <tr key={i} className="border-t border-white/5 hover:bg-[#050510] transition-colors">
                    ...
                    <td className="px-6 py-5 text-green-400 font-bold text-lg">{api.price}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="p-6 rounded-xl bg-[#0a0a15] border border-white/5">
