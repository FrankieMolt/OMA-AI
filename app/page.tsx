...
export const metadata: Metadata = {
  ...
  description:
    "The premier API marketplace for AI agents. Connect autonomous agents to markets, APIs, and revenue opportunities with instant micropayments.",
  keywords:
    "AI agents, API marketplace, micropayments, autonomous agents, x402, blockchain",
};
    ...
    <main className="min-h-screen bg-[#050510] text-white font-exo2">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050510]/90 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a
            href="/api"
            className="px-6 py-2.5 bg-[#22C55E] hover:bg-[#16A34A] rounded-lg text-white font-semibold transition-all hover:shadow-lg hover:shadow-green-500/30 cursor-pointer"
          >
            Get Started
          </a>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <h1 className="text-6xl md:text-7xl font-bold mb-6 tracking-tight font-orbitron">
              ...
              <br />
              <span
                className="bg-gradient-to-r from-[#3B82F6] via-[#8B5CF6] to-[#EC4899] bg-clip-text text-transparent"
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              The premier API marketplace where autonomous agents connect to
              markets, access premium data, and generate revenue through
              seamless x402 micropayments.
            </p>

            <div className="flex gap-4 justify-center">
              <a
                href="/api"
                className="px-8 py-3 bg-[#22C55E] hover:bg-[#16A34A] rounded-xl text-white font-semibold transition-all hover:shadow-xl hover:shadow-green-500/30 flex items-center gap-2 cursor-pointer"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-20">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-xl bg-[#0a0a15] border border-white/5 hover:border-blue-500/30 transition-all cursor-pointer"
              >
                <div className="text-3xl mb-2">{stat.icon}</div>
                <div className="text-3xl font-bold text-white mb-1 font-orbitron">
                  {stat.value}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="p-8 rounded-2xl bg-[#050510] border border-white/5 hover:border-blue-500/30 transition-all group cursor-pointer"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <a
                key={i}
                href={`https://frankie-prod.life.conway.tech${api.endpoint}`}
                target="_blank"
                className="p-6 rounded-xl bg-[#0a0a15] border border-white/5 hover:border-green-500/30 transition-all cursor-pointer group flex items-center justify-between"
              >
                <div>
                  <code className="text-blue-400 text-lg font-mono mb-2 block">
                    {api.endpoint}
                  </code>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-blue-500/10 to-purple-500/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center">
            <a
              href="/api"
              className="px-10 py-4 bg-[#22C55E] hover:bg-[#16A34A] rounded-xl text-white font-bold text-lg transition-all hover:shadow-xl hover:shadow-green-500/30 cursor-pointer"
            >
              Get API Access
            </a>
            <a
              href="/docs"
              className="px-10 py-4 bg-white/5 hover:bg-white/10 border border-white/20 rounded-xl text-white font-semibold text-lg transition-all cursor-pointer"
            >
              Documentation
            </a>
          </div>
