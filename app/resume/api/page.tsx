         ...
         <div className="max-w-4xl mx-auto space-y-12">
            <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10">
               <div className="flex items-center gap-4 mb-6">
                  <Badge variant="outline" className="rounded-sm text-[9px] uppercase tracking-widest border-blue-900/30 text-blue-400">POST</Badge>
                  <span className="text-xs font-mono text-memoria-text-hero">/api/v1/resume/parse</span>
               </div>
               <p className="text-sm text-memoria-text-whisper font-light mb-8">Submit a resume file for instant extraction of entities and skills.</p>
...
{`curl -X POST https://api.oma-ai.com/v1/resume/parse \\
  ...
  -F "file=@resume.pdf"`}
            ...
            <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10">
               <div className="flex items-center gap-4 mb-6">
                  <Badge variant="outline" className="rounded-sm text-[9px] uppercase tracking-widest border-blue-900/30 text-blue-400">POST</Badge>
                  <span className="text-xs font-mono text-memoria-text-hero">/api/v1/resume/score</span>
               </div>
               <p className="text-sm text-memoria-text-whisper font-light mb-8">Score a parsed resume against a specific job description.</p>
            </Card>
         </div>
      </section>
    </div>
