      ...
      <section className="pt-48 pb-20 px-4 md:px-14 border-b border-memoria-border-muted">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-7xl font-light tracking-tighter mb-8 font-display text-memoria-text-hero">
            Intelligence
            <br />
            <span className="text-memoria-text-secondary">Score</span>
          </h1>
          <p className="text-xl text-memoria-text-whisper max-w-2xl font-light leading-relaxed">
            Evaluate candidate alignment with specific job requirements using
      ...
      <section className="py-20 px-4 md:px-14">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10">
            ...
            />
            <Button className="w-full bg-memoria-text-hero text-memoria-bg-ultra-dark rounded-sm h-14 text-xs font-bold uppercase tracking-widest mt-8">
              Run Match Analysis
            </Button>
          </Card>
          ...
          <div className="flex flex-col items-center justify-center border border-dashed border-memoria-border-muted rounded-sm bg-memoria-bg-card/20 p-10 text-center">
            <Target
              size={48}
              className="text-memoria-text-whisper mb-6 opacity-20"
            />
            <h3 className="text-2xl font-light text-memoria-text-hero mb-4 font-display italic">
              Awaiting Input
            </h3>
            <p className="text-xs text-memoria-text-meta uppercase tracking-widest font-bold">
              Provide parameters to generate score
            </p>
          </div>
        </div>
      </section>
