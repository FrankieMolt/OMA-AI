      ...
      <section className="pt-48 pb-20 px-4 md:px-14">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-7xl font-light tracking-tighter mb-8 font-display text-memoria-text-hero">
            Service
            <br />
            <span className="text-memoria-text-secondary">Quotas</span>
          </h1>
          <p className="text-xl text-memoria-text-whisper max-w-2xl mx-auto font-light leading-relaxed">
            Simple pay-per-use pricing for AI Resume Parsing. Transparent,
            automated settlement via x402.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-xl mx-auto">
          <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10 text-center">
            ...
            <div className="flex items-baseline justify-center gap-2 mb-8">
              ...
              <span className="text-memoria-text-meta text-lg font-light uppercase tracking-widest">
                USDC
              </span>
            </div>
            <p className="text-sm text-memoria-text-whisper mb-10 font-light italic">
              Per successful neural analysis.
            </p>
            <Button className="w-full bg-memoria-text-hero text-memoria-bg-ultra-dark rounded-sm h-14 text-xs font-bold uppercase tracking-widest">
              Initialize Balance
            </Button>
          </Card>
        </div>
