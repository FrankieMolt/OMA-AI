...
export const metadata: Metadata = {
  ...
  description: 'Upload and analyze multiple resumes at once. Perfect for recruiters and HR teams processing multiple candidates.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-memoria-bg-card border border-memoria-border-muted rounded-lg p-12">
          ...
          <p className="text-lg text-memoria-text-whisper mb-8 font-light">
             Process multiple resumes simultaneously with AI-powered analysis. Perfect for 
             recruiters, HR teams, and high-volume hiring operations.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
             {[
                { title: 'Bulk Upload', desc: 'Upload up to 100 resumes in a single batch operation' },
                { title: 'Parallel Processing', desc: 'All resumes analyzed simultaneously for faster turnaround' },
                { title: 'Export Results', desc: 'Download detailed reports in CSV or JSON format' }
             ].map((feature, i) => (
