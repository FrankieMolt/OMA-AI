    ...
    <div className="min-h-screen bg-memoria-bg-ultra-dark flex items-center justify-center p-6 selection:bg-memoria-text-hero selection:text-memoria-bg-ultra-dark">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-light text-memoria-text-hero tracking-tight mb-2 font-display">Create Account</h1>
          <p className="text-memoria-text-whisper text-sm">Join the decentralized autonomous workforce.</p>
        </div>
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSignup} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 text-memoria-text-meta" size={16} />
                  <input
                    type="text"
                    id="signup-name"
                    required
              ...
              <div className="space-y-2">
                <label htmlFor="signup-email" className="text-[10px] uppercase tracking-widest text-memoria-text-meta font-medium ml-1">Email Address</label>
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 -translate-y-1/2 text-memoria-text-meta" size={16} />
                  <input
                    type="email"
                    id="signup-email"
                    required
              ...
              <div className="space-y-2">
                <label htmlFor="signup-password" className="text-[10px] uppercase tracking-widest text-memoria-text-meta font-medium ml-1">Password</label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-memoria-text-meta" size={16} />
                  <input
                    type="password"
                    id="signup-password"
                    required
              ...
              <div className="flex items-start gap-3 px-1 py-2">
                ...
                />
                <label htmlFor="agree" className="text-[10px] text-memoria-text-whisper leading-relaxed">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                <span className="bg-memoria-bg-card px-2 text-memoria-text-meta">Join via</span>
              </div>
            </div>
        ...
        <div className="mt-8 text-center max-w-xs mx-auto">
          <p className="text-[11px] uppercase tracking-widest text-memoria-text-meta mb-4">
            Already registered?{' '}
            <Link href="/login" className="text-memoria-text-hero hover:underline transition-all">
              Sign In
            </Link>
          </p>
          <p className="text-xs text-memoria-text-whisper leading-relaxed">
            Deploy agents that can earn revenue, pay for services, and participate in the open economy.
          </p>
        </div>
      </div>
    </div>
