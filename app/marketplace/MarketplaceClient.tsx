  ...
  return (
    <div className="min-h-screen bg-background selection:bg-primary selection:text-primary-foreground">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-memoria-bg-card border border-memoria-border-muted p-6 rounded-sm">
              <h3 className="text-sm font-bold text-memoria-text-hero uppercase tracking-widest mb-2">
                Autonomous Discovery
              </h3>
              <p className="text-sm text-memoria-text-whisper font-light">
                AI agents can search, compare, and select APIs without human
                intervention. Built-in semantic understanding matches
                capabilities to agent requirements.
              </p>
            </div>
            <div className="bg-memoria-bg-card border border-memoria-border-muted p-6 rounded-sm">
              <h3 className="text-sm font-bold text-memoria-text-hero uppercase tracking-widest mb-2">
              ...
              <p className="text-sm text-memoria-text-whisper font-light">
                x402 protocol enables HTTP-native crypto payments. Agents pay
                per-call automatically without wallet management or manual
                approvals.
              </p>
            </div>
            <div className="bg-memoria-bg-card border border-memoria-border-muted p-6 rounded-sm">
              ...
              <p className="text-sm text-memoria-text-whisper font-light">
                Every API is vetted for uptime, security, and documentation
                quality. Real-time performance metrics help agents choose the
                best options.
              </p>
            </div>
          </div>
                ...
                >
                  <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-8 h-full hover:border-memoria-border-active transition-all group">
                    <div className="flex justify-between items-start mb-6">
                      ...
                      <Badge
                        variant="outline"
                        className="rounded-sm text-[9px] uppercase tracking-widest border-memoria-border-muted text-memoria-text-meta"
                      >
                        {service.category}
                      </Badge>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-memoria-border-muted">
                      <div className="flex items-baseline gap-1">
                        <span className="text-lg font-light text-memoria-text-hero">
                      ...
                      <div className="flex gap-2">
                        <Button
                          variant="ghost"
                          size="sm"
                          className="h-8 w-8 p-0 rounded-sm hover:bg-memoria-bg-surface"
                        >
                          <Play size={14} />
                        </Button>
                        <Link
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-memoria-text-whisper max-w-2xl mx-auto font-light">
              From large language models to blockchain data, our marketplace
              covers every capability your autonomous agents might require.
            </p>
          </div>
            ...
            {[
              {
                ...
                name: "AI & ML",
                count: "150+",
                desc: "LLMs, vision, speech, and more",
              },
              {
                icon: <Database size={24} />,
                name: "Blockchain",
                count: "80+",
                desc: "RPC nodes, DeFi data, NFTs",
              },
              {
                icon: <Code size={24} />,
                name: "MCP Servers",
                count: "120+",
                desc: "GitHub, filesystem, databases",
              },
              {
                icon: <Globe size={24} />,
                name: "Data & APIs",
                count: "100+",
                desc: "Web scraping, weather, geolocation",
              },
            ].map((cat, i) => (
              <div
                key={i}
                className="bg-memoria-bg-ultra-dark border border-memoria-border-default p-8 rounded-sm hover:border-memoria-text-hero transition-all group"
              >
                ...
                <h3 className="text-xl font-bold text-memoria-text-hero mb-2 font-display">
                  {cat.name}
                </h3>
                <p className="text-sm text-memoria-text-whisper font-light mb-3">
                  {cat.desc}
                </p>
                <span className="text-xs text-memoria-text-meta uppercase tracking-widest font-bold">
                  {cat.count} Tools
                </span>
              </div>
            ))}
      ...
      <section className="py-20 px-4 md:px-14">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="label-whisper mb-4 block">
              Integration Process
            </span>
            <h2 className="text-4xl md:text-5xl font-light mb-4 font-display text-memoria-text-hero">
            ...
            <p className="text-lg text-memoria-text-whisper max-w-2xl mx-auto font-light">
              Three simple steps to empower your autonomous agents with API
              capabilities.
            </p>
          </div>
            ...
            {[
              {
                step: "01",
                title: "Discover APIs",
                desc: "Agents search marketplace by capability, category, or semantic matching to find the perfect APIs for their tasks.",
              },
              {
                step: "02",
                title: "Test Integration",
                desc: "Try APIs instantly with our sandbox environment. Verify compatibility before production deployment.",
              },
              {
                step: "03",
                title: "Pay as You Go",
                desc: "x402 protocol enables per-call payments. Your agents only pay for what they actually use.",
              },
            ].map((step, i) => (
              <div key={i} className="relative">
                ...
                <div className="pt-8">
                  <h3 className="text-2xl font-bold text-memoria-text-hero mb-4 font-display">
                    {step.title}
                  </h3>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  >
                    <Shield
                      size={16}
                      className="text-memoria-text-hero shrink-0 mt-0.5"
                    />
                    {item}
                  </li>
                ))}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-memoria-bg-ultra-dark border border-memoria-border-default p-6 rounded-sm"
                  >
                    <div className="text-3xl font-black text-memoria-text-hero mb-1 font-display">
                      {stat.value}
                    </div>
                    <div className="text-[10px] text-memoria-text-meta uppercase tracking-widest">
                      {stat.label}
                    </div>
                  </div>
                ))}
