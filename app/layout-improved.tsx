/**
 * App Layout - Root layout with providers, metadata, and improved CSS
 * UPDATED: Switched to improved CSS with loading states, hover effects, and animations
 * UPDATED: Mobile menu integrated
 */

import type { Metadata, Viewport } from 'next'
import { Inter, IBM_Plex_Sans, Space_Grotesk } from 'next/font/google'
import './globals-improved.css' // Updated to improved CSS
    ...
    <html lang="en" className="dark">
      ...
      <body className={`${inter.variable} ${ibmPlexSans.variable} ${spaceGrotesk.variable} bg-zinc-950 text-zinc-50 antialiased selection:bg-zinc-800 custom-scrollbar smooth-scroll`}>
        ...
        <nav className="hidden md:flex items-center gap-8 px-8 py-4 bg-zinc-900/50 border-b border-zinc-800/50 backdrop-blur-md">
          ...
          <button className="flex items-center gap-2 px-6 py-2.5 rounded-xl btn-primary focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-lg hover:shadow-xl transition-all duration-200">
            Get API Key
          </button>
        </nav>
