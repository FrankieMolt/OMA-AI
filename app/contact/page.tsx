...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with the OMA-AI team. Support, partnerships, and general inquiries.',
}
    ...
    <div className="min-h-screen bg-memoria-bg-ultra-dark text-memoria-text-hero py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-xl text-memoria-text-whisper mb-12 max-w-2xl">
          Have questions about OMA-AI? Need support with integration? 
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <form className="space-y-6">
              <div>
                <label className="block text-sm text-memoria-text-meta mb-2">Name</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-sm text-memoria-text-meta mb-2">Email</label>
                <input 
                  type="email" 
                  className="w-full bg-memoria-bg-surface border border-memoria-border-default rounded-sm px-4 py-3 text-memoria-text-hero focus:border-memoria-border-active focus:outline-none"
              ...
              <div>
                <label className="block text-sm text-memoria-text-meta mb-2">Subject</label>
              ...
              <div>
                <label className="block text-sm text-memoria-text-meta mb-2">Message</label>
                <textarea 
                  rows={6}
          ...
          <div className="space-y-8">
            <div>
              ...
              <a href="mailto:support@oma-ai.com" className="text-memoria-text-whisper hover:text-memoria-text-hero">
                support@oma-ai.com
              </a>
            </div>
            ...
            <div>
              ...
              <a href="https://discord.gg/oma-ai" className="text-memoria-text-whisper hover:text-memoria-text-hero">
                Join our community →
              </a>
            </div>
            ...
            <div>
              ...
              <a href="https://twitter.com/oma_ai" className="text-memoria-text-whisper hover:text-memoria-text-hero">
                @oma_ai
              </a>
            </div>
            ...
            <div>
              ...
              <a href="https://github.com/oma-ai" className="text-memoria-text-whisper hover:text-memoria-text-hero">
                github.com/oma-ai
              </a>
            </div>
