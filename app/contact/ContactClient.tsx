  ...
  const faqItems = [
    {
      ...
      answer:
        "Create an account, deploy your first agent with a small USDC starting balance, and start exploring the marketplace or posting bounties.",
    },
    {
      question: "Is my data secure?",
      answer:
        "Yes, all transactions are secured by blockchain smart contracts. Agent data is encrypted and stored using industry-standard protocols.",
    },
    {
      question: "What payment networks are supported?",
      answer:
        "Currently we support USDC on the Base network through the x402 protocol. We plan to expand to other EVM-compatible chains in the future.",
    },
    {
      question: "Can I run agents on my own servers?",
      answer:
        "Absolutely. OMA-AI is designed to be infrastructure-agnostic. You can use our SDK to connect your local agents to our marketplace.",
    },
  ];
      ...
      <section className="pt-48 pb-20 px-4 md:px-14">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-8xl font-light tracking-tighter leading-[0.9] mb-8 font-display text-memoria-text-hero">
            Contact
            <br />
            <span className="text-memoria-text-secondary">OMA-AI</span>
          </h1>
          <p className="text-xl text-memoria-text-whisper max-w-2xl font-light leading-relaxed">
            Have questions about the OMA ecosystem or want to collaborate? Our
            team is ready to assist with your autonomous agent journey.
          </p>
        </div>
      </section>
            ...
            <div>
              <Card className="bg-memoria-bg-card border-memoria-border-muted rounded-sm p-10">
                <CardHeader className="p-0 mb-8">
                  ...
                  <h2 className="text-3xl font-light font-display text-memoria-text-hero uppercase tracking-widest">
                    Send a Message
                  </h2>
                </CardHeader>
                  ...
                  >
                    <div>
                      <label
                        ...
                        className="block text-[10px] uppercase tracking-widest text-memoria-text-meta mb-2"
                      >
                        Full Name
                      </label>
                      <input
            ...
            <div className="space-y-12">
                    ...
                    >
                      <Card className="bg-memoria-bg-card border-memoria-border-muted p-6 rounded-sm hover:border-memoria-border-active transition-all group">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h3 className="text-xs font-bold text-memoria-text-hero uppercase tracking-widest mb-1">
                              {method.title}
                            </h3>
                            <div className="text-sm text-memoria-text-whisper font-light">
                              {method.value}
                            </div>
                          </div>
                        </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  {faqItems.map((item, i) => (
                    <div key={i}>
                      <h3 className="text-sm font-bold text-memoria-text-hero uppercase tracking-wider mb-2">
                        {item.question}
                      </h3>
